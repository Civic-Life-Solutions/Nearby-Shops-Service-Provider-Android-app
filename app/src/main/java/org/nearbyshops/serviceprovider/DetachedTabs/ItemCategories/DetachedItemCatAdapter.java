...
public class DetachedItemCatAdapter extends RecyclerView.Adapter<DetachedItemCatAdapter.ViewHolder>{
    ...
    public DetachedItemCatAdapter(List<ItemCategory> dataset, Context context, DetachedItemCatFragment activity, ReceiveNotificationsFromAdapter notificationReceiver) {
